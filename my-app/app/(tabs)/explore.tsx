...
// Obstacle d'exemple - est volontairement présent au démarrage.
const exampleObstacle: Obstacle = {
  id: '1',
  title: 'Feu de forêt',
  instructions: 'Le feu bloque la A31 dans les deux sens sur 8km, il faut donc passer par les petites routes de campagnes depuis Metz pour aller en direction du Luxembourg.',
  latitude: '49.106841',
  longitude: '6.176418',
